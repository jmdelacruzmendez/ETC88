...
## Estructura (≈ 3 h) — Plenario → Breakouts → Plenario

### PLENARIO de apertura (≈ 55 min · todos juntos)
...
#### GUÍAS + MÚSICA (juntos)
*(Música se integra a guías porque dan los testimonios con ellos.)*
...
### PLENARIO de cierre (≈ 20 min · todos juntos)

| Bloque | Min | Quién | Contenido |
|---|---|---|---|
| Cada área comparte 1 acuerdo | 8 | Coords | qué se llevó cada equipo |
| Avisos + próximos pasos | 5 | Co-Dir | calendario, F2, pagos |
| **Oración + mensaje final acorde a la temática** | 7 | Paul/Sor + Co-Dir | mensaje de expedición/tesoro · envío |

---

## Materiales para F1
- **Guía del ETC 88 impresa** (una por persona) — la "carpeta".
- Calendario impreso (va dentro de la Guía).
- Tarjetas de color para las parejas de guías.
- Plantilla de presupuesto por área (para que cada coord la entregue).
- Hoja de "cómo preparar un testimonio" (va en la Guía).

## Lo que cada coord TRAE a F1 (de la reunión del 4-jun)
- Presupuesto de su área + lista de materiales.
- 3 dudas/brechas.
- Mensaje único ya bajado a su gente.

## Salidas de F1
- Todo el equipo tiene su **carpeta** (Guía 88).
