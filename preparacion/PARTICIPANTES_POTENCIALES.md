> **DOCUMENTO DE TRABAJO — no es entregable oficial.** Lista de captación de participantes (no equipo). Datos sensibles de la comunidad → NO va a entregables compartibles. Los entregables oficiales son los 2 documentos + 2 hojas generados desde data/ (ver CLAUDE.md).

# Participantes potenciales — ETC 88
### Cruce: Doc de invitados (Borrador abril) × Formulario del equipo (col "¿a quién invitarías?")

> **Meta de participantes: ~52** (= 100 en la casa − 48 operativos). Esto es el arranque de captación, **no** la lista final. Nadie aquí está confirmado como participante.

## 0. Fuentes y frescura de los datos (leer primero)
| Fuente | Qué aporta | Frescura | Cómo se leyó |
|---|---|---|---|
...
|---|---|---|---|---|
| Joemely Nathacha Smith de la Rosa | 18 | Ámbar Jáquez | Amigo | ✅ sí |
| Hilary Marlene Vásquez Tellería | 18 | Ámbar Jáquez | Amigo | — nuevo |
| Karen Indiana Berroa Santana | 21 | Brianelis Abreu | Amigo | ✅ sí |
| Jasiris Moracher | 32 | Candy Gatwood | Amigo | — nuevo |
| Jennifer Pérez | 33 | Candy Gatwood | Amigo | — nuevo |
