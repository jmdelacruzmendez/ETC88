...
gastos = [
    ...
    ("19/08","Pago a JM x pago Biblias ETC 88",35360,"Reembolso a JM. 52 biblias × 680 = 35,360 exactos. El presupuesto solo tenía 50 (34,000): las 2 de más (1,360) son las que figuraban como 'las pagaría Camila' y terminaron dentro de lo que pagó el grupo"),
...
cruce = [
 ...
 ('Casa','Habitaciones para pequeños grupos (2 noches)',None,None,HAB_TOTAL,0,f'Los {HAB_TOTAL:,} son firmes: es lo que queda del pago a la casa tras el hospedaje y el jueves (240,220 − 228,920 − 9,500). La tarifa de {HAB_TARIFA:,.0f}/noche es INFERIDA de ahí. El desglose verbal del 10-sep (700 × 2 noches + 800 de una habitación extra = 2,200) daría 400 más de lo que se pagó: diferencia sin explicar, pendiente de la factura de la casa'),
 ...
 ('Materiales','Biblias (52 × 680)',34000,32400,35360,0,'Se pidieron 52 y el grupo pagó las 52: 52 × 680 = 35,360 exactos (reembolso a JM, 19/08). El presupuesto oficial solo contemplaba 50 (34,000) porque 2 las pagaría Camila; esas 2 (1,360) quedaron dentro de lo que pagó el grupo. Financiadas en parte por 16,500 de donaciones en efectivo etiquetadas "biblia"'),
...
pendientes = [
 ...
 ('NOTA',    'Biblias: las 2 de Camila', 'Se pidieron 52 biblias y el grupo pagó las 52: el reembolso a JM del 19/08 es 35,360 = 52 × 680 exactos. El presupuesto solo contemplaba 50 (34,000) porque 2 las pagaría Camila Fernández; esas 2 quedaron dentro de lo que pagó el grupo. En las 49 donaciones en efectivo no hay ningún aporte suyo ni ningún movimiento de 1,360, y en la especie solo figura por los separadores de libros (750).', 'Confirmar con Camila y con Juan Manuel: si ella puso 1,360 de su bolsillo, o se le reembolsa, o se registra como donación en especie (el costo del retiro subiría a 618,429 y la especie a 93,765). La caja y el cuadre con el banco no cambian en ningún caso.'),
 ('NOTA',    'Habitaciones de pequeños grupos: 400 sin explicar', f'Los {HAB_TOTAL:,} son firmes: es lo que queda del pago a la casa tras el hospedaje (228,920) y el jueves (9,500). La tarifa de {HAB_TARIFA:,.0f}/noche está inferida de ahí. El desglose que dio la dirección el 10-sep (700 × 2 noches + 800 de una habitación extra) suma 2,200, o sea 400 más de lo que la casa cobró.', 'Una línea de la factura de la casa lo cierra. No afecta ningún total: lo pagado es lo pagado.'),
...
checks = [
 ...
 ('Biblias: el pago de 35,360 = 52 × 680 exactos', 35360, 52 * 680, True, 'el presupuesto tenía 50 (34,000); las 2 de más (1,360) son las que iba a pagar Camila'),
 ('Biblias: donaciones en efectivo etiquetadas "biblia"', 16500, _bib, True, 'Roosbert, Pamela Nivar, Carol, Kharla, Wirna'),
...
for label, val, nota in [
    ...
    ('Habitaciones para pequeños grupos, 2 noches', HAB_TOTAL, f'monto firme; tarifa inferida {HAB_TARIFA:,.0f}/noche. El desglose verbal (700 × 2 + 800 = 2,200) daría 400 más'),
