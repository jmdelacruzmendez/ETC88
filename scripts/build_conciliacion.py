...
pendientes = [
 ...
 ('ABIERTO', 'Formaciones Sta. Clara 10,000', 'El director confirma 5 × 2,000 = 10,000 pagados (la extraordinaria de 3,000 sí está en el ledger, 19/08). Los 10,000 no están en el ledger. estado.json (14-jun) registra que Juan Manuel los pagó el 07-jun con dinero personal, "deuda pendiente de reembolso". No hay reembolso en gastos.', f'Decidir: reembolsar a JM (el disponible baja a {REAL_CUENTAS - FORMACIONES_SIN_LEDGER:,}) o dejarlo como donación (el costo económico sube a {COSTO_COMPLETO:,.0f}). Registrarlo en el ledger en cualquiera de los dos casos.'),
 ...
 ('ABIERTO', 'Pagaron y no fueron', 'Equipo: Mary Carmen Ramírez pagó (al menos una porción) y no asistió. Participantes: Amanda Rivera pudo haber aportado algo (invitada por Pamela Colón y Roselyn Quiroz); Boris pagó, no fue, se le devolvió una porción y el neto de 1,500 entró como donación de Jonathan Medina (31/08: "diferencia de la devuelta del pago de participante caído"). No hay reembolso en gastos: la devolución se hizo antes de depositar.', 'Verificar en las pestañas Pagos / Pagos Participantes del panel: montos originales, devueltos y quién más pagó sin asistir. Con eso el costo por persona y la lista de asistentes quedan exactos.'),
 ('ABIERTO', 'Participantes: 4,200 por cobrar', f'Esperado 46 × 3,500 = {PART_ESPER:,}; recaudado {PARTICIP:,}. No es una persona entera: abonos parciales.', 'Quiénes deben y si se cobra.'),
...
for k, v in [
    ...
    ('estado.json del repo', 'Caja de junio: reserva 23,600 (07-jun, devuelta) y salón 10,000 pagado por Juan Manuel con dinero personal (07-jun, deuda pendiente).'),
