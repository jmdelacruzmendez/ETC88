...
form = [
 ...
 ('F4 · Conociendo el terreno (lectura de perfiles)', '19-jul', 1500, 0, 1500, 3000),
 ('Reunión coords (jue 4-jun virtual)', '4-jun', 0, 0, 0, 0),
 ('Convivencia / Retiro (programar temprano · concluye al mediodía)', '16-ago', 4000, 2000, 2000, 8000),
 ('Ensayo General (incluye almuerzo del equipo)', '23-ago', 15000, 0, 1000, 16000),
 ('Conciliación pre-ETC (cierre pagos + correcciones)', '30-ago', 1500, 0, 500, 2000),
