...
- Cuota de cada participante: {n(CUOTA_P)}, que cubre el {CUOTA_P / (SALIDAS / PERSONAS) * 100:.0f}% de su costo de caja; dos de los 48 participantes estaban exonerados, invitados de la sor Angelina
