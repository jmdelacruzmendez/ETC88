...
L.append("="*60)
L.append("  ROSTER:")
L.append("    • Cupo varón en cocina (Roselyn fuera): confirmar Randolph u otro.")
L.append("    • Confirmar formularios pendientes: Daylin, Olanlly, Pamela, Frank.")
L.append("    • La Vega: ¿1 o 2 asesores de comunidad?")
L.append("    • Backups guías: Rodolfo · Scarlett · Kamila Todd (definir rol si entran).")
L.append("  EQUIPOS AUXILIARES (responsable a asignar antes de F1):")
L.append("    • Recaudación y Donaciones · Guagua · Profondo · Intersección.")
L.append("  RAÍZ ESPIRITUAL / PROGRAMA:")
L.append("    • Definir hilo principal de los 5 clústeres del formulario + lema + cita (esta semana).")
L.append("    • Programa de las 5 formaciones esta semana.")
L.append("  FINANZAS:")
L.append("    • Profondo #2: definir actividad + meta (deadline 30-jun).")
L.append("    • Confirmar precio casa 2026 + exención con Padre Paul.")
L.append("")
